...
if __name__ == "__main__":
    ...
    # Revenue paths
    plt.figure()
    plt.plot(years_axis, 100*((rev_paths/revenue0)**(1/np.maximum(years_axis,1).reshape(-1,1))-1))
    ...
    # Cost paths
    plt.figure()
    plt.plot(years_axis, 100*((cost_paths/(cogs0+opex0))**(1/np.maximum(years_axis,1).reshape(-1,1))-1))
